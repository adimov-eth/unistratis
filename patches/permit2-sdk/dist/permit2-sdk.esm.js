...
var AllowanceTransfer = /*#__PURE__*/ (function () {
  ...
  AllowanceTransfer.getPermitData = function getPermitData(permit, permit2Address, chainId) {
    !MaxSigDeadline.gte(permit.sigDeadline)
      ? process.env.NODE_ENV !== 'production'
        ? invariant(false, 'SIG_DEADLINE_OUT_OF_RANGE')
        : invariant(false)
      : void 0
...
function validatePermitDetails(details) {
  !MaxOrderedNonce.gte(details.nonce)
    ? process.env.NODE_ENV !== 'production'
      ? invariant(false, 'NONCE_OUT_OF_RANGE')
      : invariant(false)
    : void 0
  !MaxAllowanceTransferAmount.gte(details.amount)
    ? process.env.NODE_ENV !== 'production'
      ? invariant(false, 'AMOUNT_OUT_OF_RANGE')
      : invariant(false)
    : void 0
  !MaxAllowanceExpiration.gte(details.expiration)
    ? process.env.NODE_ENV !== 'production'
      ? invariant(false, 'EXPIRATION_OUT_OF_RANGE')
      : invariant(false)
    : void 0
}
...
var SignatureTransfer = /*#__PURE__*/ (function () {
  ...
  SignatureTransfer.getPermitData = function getPermitData(permit, permit2Address, chainId, witness) {
    !MaxSigDeadline.gte(permit.deadline)
      ? process.env.NODE_ENV !== 'production'
        ? invariant(false, 'SIG_DEADLINE_OUT_OF_RANGE')
        : invariant(false)
      : void 0
    !MaxUnorderedNonce.gte(permit.nonce)
      ? process.env.NODE_ENV !== 'production'
        ? invariant(false, 'NONCE_OUT_OF_RANGE')
        : invariant(false)
      : void 0
