...
var h = [
  ...
  g = (function () {
    function e() {}
    return (
      (e.getPermitData = function (e, n, r) {
        m.gte(e.sigDeadline) || t(!1)
        var a = f(n, r)
        return (function (e) {
          return !Array.isArray(e.details)
        })(e)
          ? (w(e.details), { domain: a, types: T, values: e })
          : (e.details.forEach(w), { domain: a, types: v, values: e })
      }),
...
function x() {
  ...
  return (
    ...
    o(T, 'constructor', m),
    o(m, 'constructor', l),
    (l.displayName = o(m, s, 'GeneratorFunction')),
    ...
    (e.mark = function (e) {
      return (
        Object.setPrototypeOf ? Object.setPrototypeOf(e, m) : ((e.__proto__ = m), o(e, s, 'GeneratorFunction')),
...
var A = [
  ...
  D = (function () {
    function e() {}
    return (
      (e.getPermitData = function (e, n, r, a) {
          ...
          ? (I(e.permitted),
            {
              ...
              types: a
                ...
                : E,
              values: a ? Object.assign(e, { witness: a.witness }) : e,
            })
...
;(exports.AllowanceProvider = (function () {
  function e(e, t) {
    ;(this.provider = e),
      ...
      (this.permit2 = new a.Contract(this.permit2Address, L, this.provider))
  }
  var t = e.prototype
  return (
  ...
  (exports.AllowanceTransfer = g),
  (exports.InstantExpiration = c),
  (exports.MaxAllowanceExpiration = u),
  (exports.MaxAllowanceTransferAmount = p),
  (exports.MaxOrderedNonce = y),
  (exports.MaxSigDeadline = m),
  (exports.MaxSignatureTransferAmount = d),
  (exports.MaxUint160 = s),
  (exports.MaxUint256 = o),
  (exports.MaxUint48 = i),
  (exports.MaxUnorderedNonce = l),
