...
function m(t, r, n) {
  return r && p(t.prototype, r), n && p(t, n), t
}
function h(t, r) {
    ...
    return (
      ...
      (r.toSignificant = function (t, r, n) {
        void 0 === r && (r = { groupSeparator: '' }),
          ...
          t > 0 || o(!1),
          y.set({ precision: t + 1, rounding: g[n] })
        var e = new y(this.numerator.toString()).div(this.denominator.toString()).toSignificantDigits(t)
    ...
    return (
      ...
      (n.toExact = function (t) {
        return (
          ...
          (I.DP = this.currency.decimals),
          new I(this.quotient.toString()).div(this.decimalScale.toString()).toFormat(t)
        )
      }),
      m(r, [
        {
...
var N = (function (t) {
    ...
    return (
      (n.add = function (r) {
        return F(t.prototype.add.call(this, r))
      }),
      (n.subtract = function (r) {
        return F(t.prototype.subtract.call(this, r))
      }),
      (n.multiply = function (r) {
        return F(t.prototype.multiply.call(this, r))
      }),
      (n.divide = function (r) {
        return F(t.prototype.divide.call(this, r))
      }),
      (n.toSignificant = function (r, n, e) {
        return void 0 === r && (r = 5), t.prototype.multiply.call(this, x).toSignificant(r, n, e)
      }),
      (n.toFixed = function (r, n, e) {
        return void 0 === r && (r = 2), t.prototype.multiply.call(this, x).toFixed(r, n, e)
      }),
      r
    )
  })(E),
...
var U,
  ...
  C =
    (((U = {})[1] = new b(1, '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', 18, 'WETH', 'Wrapped Ether')),
    (U[3] = new b(3, '0xc778417E063141139Fce010982780140Aa0cD5Ab', 18, 'WETH', 'Wrapped Ether')),
    (U[4] = new b(4, '0xc778417E063141139Fce010982780140Aa0cD5Ab', 18, 'WETH', 'Wrapped Ether')),
    (U[5] = new b(5, '0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6', 18, 'WETH', 'Wrapped Ether')),
    (U[42] = new b(42, '0xd0A1E359811322d97991E03f863a0C30C2cF029C', 18, 'WETH', 'Wrapped Ether')),
    (U[10] = new b(10, '0x4200000000000000000000000000000000000006', 18, 'WETH', 'Wrapped Ether')),
    (U[69] = new b(69, '0x4200000000000000000000000000000000000006', 18, 'WETH', 'Wrapped Ether')),
    (U[42161] = new b(42161, '0x82aF49447D8a07e3bd95BD0d56f35241523fBab1', 18, 'WETH', 'Wrapped Ether')),
    (U[421611] = new b(421611, '0xB47e6A5f8b33b3F17603C83a0535A9dcD7E32681', 18, 'WETH', 'Wrapped Ether')),
    U),
  D = (function (t) {
    function r(r) {
...
;(exports.CurrencyAmount = A),
  ...
  (exports.sqrt = function (t) {
    if ((i.greaterThanOrEqual(t, q) || o(!1), i.lessThan(t, B))) return i.BigInt(Math.floor(Math.sqrt(i.toNumber(t))))
    var r, n
    for (r = t, n = i.add(i.divide(t, L), S); i.lessThan(n, r); ) (r = n), (n = i.divide(i.add(i.divide(t, n), n), L))
    return r
  }),
  (exports.validateAndParseAddress = T)
