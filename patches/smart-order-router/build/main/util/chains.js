...
exports.V2_SUPPORTED = [ChainId.MAINNET, ChainId.KOVAN, ChainId.GÖRLI, ChainId.RINKEBY, ChainId.ROPSTEN]
exports.HAS_L1_FEE = [
  ChainId.OPTIMISM,
  ChainId.OPTIMISM_GOERLI,
  ChainId.OPTIMISTIC_KOVAN,
...
exports.NATIVE_NAMES_BY_ID = {
  [ChainId.STRATIS]: ['STRAX', 'STRAX', '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee'],
  [ChainId.MAINNET]: ['ETH', 'ETHER', '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee'],
  [ChainId.AURORIA]: ['tSTRAX', 'tSTRAX', '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee'],
  [ChainId.RINKEBY]: ['ETH', 'ETHER', '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee'],
  [ChainId.GÖRLI]: ['ETH', 'ETHER', '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee'],
  [ChainId.KOVAN]: ['ETH', 'ETHER', '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee'],
  [ChainId.ROPSTEN]: ['ETH', 'ETHER', '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee'],
  ...
  [ChainId.OPTIMISTIC_KOVAN]: ['ETH', 'ETHER', '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee'],
  [ChainId.ARBITRUM_ONE]: ['ETH', 'ETHER', '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee'],
  [ChainId.ARBITRUM_RINKEBY]: ['ETH', 'ETHER', '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee'],
...
exports.WRAPPED_NATIVE_CURRENCY = {
  ...
  [ChainId.STRATIS]: new sdk_core_1.Token(
    105105,
...
class StratisNativeCurrency extends sdk_core_1.NativeCurrency {
  ...
  get wrapped() {
    if (!isStratis(this.chainId)) throw new Error('Not Stratis')
  ...
  constructor(chainId) {
    if (!isStratis(chainId)) throw new Error('Not Stratis')
...
class ExtendedEther extends sdk_core_1.Ether {
  get wrapped() {
    if (this.chainId in exports.WRAPPED_NATIVE_CURRENCY) return exports.WRAPPED_NATIVE_CURRENCY[this.chainId]
...
function nativeOnChain(chainId) {
  ...
  if (isStratis(chainId)) cachedNativeCurrency[chainId] = new StratisNativeCurrency(chainId)
  else if (isMatic(chainId)) cachedNativeCurrency[chainId] = new MaticNativeCurrency(chainId)
  ...
  else if (isBsc(chainId)) cachedNativeCurrency[chainId] = new BscNativeCurrency(chainId)
