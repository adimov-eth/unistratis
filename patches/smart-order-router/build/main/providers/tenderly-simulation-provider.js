    ...
    if (
      ...
      try {
        ...
        return Object.assign(Object.assign({}, swapRoute), {
          simulationStatus: simulation_provider_1.SimulationStatus.Failed,
        });
      }
    }
    try {
...
class TenderlySimulator extends simulation_provider_1.Simulator {
  constructor(
    ...
    this.overrideEstimateMultiplier =
      overrideEstimateMultiplier !== null &&
      overrideEstimateMultiplier !== void 0
        ? overrideEstimateMultiplier
        : {};
  }
  async simulateTransaction(
    ...
    if (
      [util_1.ChainId.CELO, util_1.ChainId.CELO_ALFAJORES].includes(chainId)
    ) {
      const msg = 'Celo not supported by Tenderly!';
      util_1.log.info(msg);
      return Object.assign(Object.assign({}, swapRoute), {
        simulationStatus: simulation_provider_1.SimulationStatus.NotSupported,
      });
    }
    ...
    const blockNumber = await (providerConfig === null ||
    providerConfig === void 0
      ? void 0
      : providerConfig.blockNumber);
    let estimatedGasUsed;
    const estimateMultiplier =
      (_a = this.overrideEstimateMultiplier[chainId]) !== null && _a !== void 0
        ? _a
    ...
    if (swapOptions.type == routers_1.SwapType.UNIVERSAL_ROUTER) {
      ...
      const approvePermit2Calldata = erc20Interface.encodeFunctionData(
        'approve',
        [universal_router_sdk_1.PERMIT2_ADDRESS, constants_1.MaxUint256]
      );
      ...
      const permit2Interface =
        Permit2__factory_1.Permit2__factory.createInterface();
      ...
      const swap = {
        ...
        block_number:
          chainId == util_1.ChainId.ARBITRUM_ONE && blockNumber
            ? blockNumber - 5
            : undefined,
      };
      const body = {
      ...
      estimatedGasUsed = ethers_1.BigNumber.from(
        (
    ...
    const {
      ...
      quoteGasAdjusted,
    } = await (0, gas_factory_helpers_1.calculateGasUsed)(
      chainId,
      swapRoute,
      estimatedGasUsed,
      this.v2PoolProvider,
    ...
    return Object.assign(
      Object.assign(
        {},
        (0, gas_factory_helpers_1.initSwapRouteFromExisting)(
          swapRoute,
          this.v2PoolProvider,
          this.v3PoolProvider,
          quoteGasAdjusted,
      ...
      { simulationStatus: simulation_provider_1.SimulationStatus.Succeeded }
    );
  }
