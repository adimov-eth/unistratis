...
exports.MixedRouteWithValidQuote =
  exports.V3RouteWithValidQuote =
  exports.V2RouteWithValidQuote =
    void 0;
...
class V2RouteWithValidQuote {
  ...
  toString() {
    return `${this.percent.toFixed(
      2
    )}% QuoteGasAdj[${this.quoteAdjustedForGas.toExact()}] Quote[${this.quote.toExact()}] Gas[${this.gasEstimate.toString()}] = ${(0,
    routes_1.routeToString)(this.route)}`;
  }
}
