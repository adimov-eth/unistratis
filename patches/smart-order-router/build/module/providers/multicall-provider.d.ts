...
export declare type CallSameFunctionOnMultipleContractsParams<
  TFunctionParams,
...
export declare type CallSameFunctionOnContractWithMultipleParams<
  TFunctionParams,
  TAdditionalConfig = any
> = {
  address: string;
...
export declare type CallMultipleFunctionsOnSameContractParams<
  TFunctionParams,
  TAdditionalConfig = any
> = {
  address: string;
...
export declare abstract class IMulticallProvider<TMulticallConfig = any> {
   ...
   * @returns {*}
   */
  abstract callSameFunctionOnMultipleContracts<
   ...
   * @returns {*}
   */
  abstract callSameFunctionOnContractWithMultipleParams<
    TFunctionParams extends any[] | undefined,
    TReturn = any
  >(
  ...
  abstract callMultipleFunctionsOnSameContract<
    TFunctionParams extends any[] | undefined,
    TReturn = any
  >(
