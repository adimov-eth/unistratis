...
export default function Loader({
  ...
  return (
    ...
    >
      <path
        d="M12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 9.27455 20.9097 6.80375 19.1193 4.88045C17.3289 2.95715 14.8193 2 12 2Z"
