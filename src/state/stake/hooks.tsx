...
import { USDC_STRATIS, USDT, WRAPPED_NATIVE_CURRENCY } from '../../constants/tokens'
...
const STAKING_REWARDS_INFO: {
  ...
  // 105105: [
  //   {
  //     tokens: [WRAPPED_NATIVE_CURRENCY[SupportedChainId.STRATIS] as Token, USDC_STRATIS],
  //     stakingRewardAddress: '0x7FBa4B8Dc5E7616e59622806932DBea72537A56b',
  //   },
  //   {
  //     tokens: [WRAPPED_NATIVE_CURRENCY[SupportedChainId.STRATIS] as Token, USDT],
